...
;;
;; Hint: Use your 'myMap' function from before to map all elements in a sublist. <--- Bad hint????
...
(defun myflatMap (f l)
  ...
  (let (
    ...
    ;; Now the new list is saved as mapped
    (myMap f flatten)

  )
)

(write(myflatMap (lambda (a) (+ a 2)) (list (list 1 2 3) (list 4 5 6)))) ;; Should return: (5 7 9 11)
